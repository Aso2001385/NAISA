...
|商品画像|order_item_image|||〇|〇||
|届先郵便番号|order_post|||〇|||
|届先住所|order_addless|||〇|||
|発送通知日時|order_send|||||now関数|
|受取通知日時|order_recived|||||now関数|
...
|和名|属性名|型|PK|NN|FK|備考|
|:---|:---|:---|:---:|:---:|:---:|:---|
|商品番号|comment_item_id|〇|〇|〇||
|ユーザー番号|comment_user_id|〇|〇|〇||
|コメント内容|comment_contents||〇|〇||
