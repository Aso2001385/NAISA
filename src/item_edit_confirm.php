...
if($act['check']){
    ...
    $_SESSION['now_image_name'] = $_POST['now_image_name'];
    $_SESSION['now_item_id'] = $_POST['now_item_id'];
}
...
<div class="contents">
    <form action="item_edit_act.php" enctype="multipart/form-data" method="post">
