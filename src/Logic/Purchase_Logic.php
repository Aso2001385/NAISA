...
class Purchase_Logic{
    ...
    */
    ...
    public static function buy_act($data)
    {
        ...
        $subject = "出品中の商品が購入されました";
        $links = ":order.php?item_id={$data['item_id']},user_id={$data['user_id']}";
    ...
    public static function get_order_by_id($id)
    {
        ...
        $order_data = $order_ex->get_singul_by_id($id);
    ...
    public static function get_order_by_item_id($id)
    {
        ...
        $order_data = $order_ex->get_singul_by_item_id($id);
